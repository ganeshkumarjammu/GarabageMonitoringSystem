...
String BOTtoken = "5753059572:AAGnH9Rc7qfFihMLXeEZjDv4uEeX6bXrvsA";  // your Bot Token (Get from Botfather)

// Use @myidbot to find out the chat ID of an individual or a group
// Also note that you need to click "start" on a bot before it can
// message you
String CHAT_ID = "-1001828075177";
...
//     / bot.sendMessage(chat_id, "Unauthorized user", "");
    ...
    if ((text == "/start")||(text == "/start@Tech1044Bot") ) {
    ...
    if ((text == "/flash")||(text == "/flash@Tech1044Bot") ) {
      flashState = !flashState;
      digitalWrite(FLASH_LED_PIN, flashState);
      Serial.println("Change flash LED state");
    }
    if ((text == "/photo")||(text == "/photo@Tech1044Bot") ){
      sendPhoto = true;
